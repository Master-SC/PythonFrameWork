...
@ddt
class courseCsvData_test(unittest.TestCase):
    ...
    @data(*getCSVData("C:\\Worspace\\SeleniumWithPython\\PythonFrameWork\\TestData.csv"))
    @unpack
    def test_courses_enrollment_payment_Error_Csv(self, emailID, pwdID, shortName, fulName, cardNum, cardExp, cardCvv):
        '''
